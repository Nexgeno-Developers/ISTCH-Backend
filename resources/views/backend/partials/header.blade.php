    ...
    <div class="page-container topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            @php
                ...
                $backendLogoUrl = $backendLogoId ? uploaded_asset($backendLogoId) : asset('assets/backend/img/logo.png');
            @endphp
            <a href="" class="logo">
                <span class="logo-light">
                    <span class="logo-lg"><img src="{{ $backendLogoUrl }}" alt="logo"></span>
                    <span class="logo-sm"><img src="{{ $backendLogoUrl }}" alt="small logo"></span>
                </span>

                <span class="logo-dark">
                    <span class="logo-lg"><img src="{{ $backendLogoUrl }}" alt="dark logo"></span>
                    <span class="logo-sm"><img src="{{ $backendLogoUrl }}" alt="small logo"></span>
                </span>
            </a>
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <!-- Visit Site Link -->
            @php
                $backendCompanyWebsite = get_setting('website');
            @endphp
            @if(!empty($backendCompanyWebsite))
                <div class="topbar-item d-none d-sm-flex">
                    <a href="{{ $backendCompanyWebsite }}" target="_blank" rel="noopener" class="topbar-link">
