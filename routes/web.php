...
Route::prefix('backend')->group(function () {
    ...
    Route::get('/password/forgot', [AuthController::class, 'showForgotPasswordForm'])->middleware(['auth.guest', 'auth.backend.access'])->name('backend.password.request');
    ...
    Route::get('/password/reset/{token}', [AuthController::class, 'showResetForm'])->middleware(['auth.guest', 'auth.backend.access'])->name('backend.password.reset');
    ...
    Route::middleware(['auth.backend'])->group(function () {
        ...
        Route::prefix('command')->group(function () {
            ...
            Route::get('optimize-clear', [CommandController::class, 'optimizeClear'])->name('backend.command.optimize-clear');
